...
def test_dashboard_fetches_snapshot_only_on_reconnect() -> None:
    ...
    # 1. Verify hasConnected is defined
    ...
    # 2. Verify loadSnapshot() is called inside if (hasConnected) condition
    ...
    # 3. Verify hasConnected is set to true after the condition
